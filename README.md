...
**Q: "Google Places APIキーが無効です"エラーが出る**
```
A: 以下を確認してください：
- Vercelダッシュボードで環境変数GOOGLE_MAPS_API_KEY が正しく設定されているか
- Google Cloud ConsoleでPlaces APIが有効化されているか
- APIキーの制限設定でリファラーが正しく設定されているか
- 請求アカウントが有効になっているか
```
